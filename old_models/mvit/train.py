...
import os 
import sys
from network import MVITNetwork
from sklearn.utils.class_weight import compute_class_weight
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../..")))
from lossFun import FocalLoss
from dataloader import  get_mvit_dataset, create_val_train_splits, get_label_mapping
...
if __name__ == "__main__":
    ...
    features,labels, fps_list=get_mvit_dataset(train_set_path)
