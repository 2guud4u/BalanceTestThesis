...
import os 
import sys
from network import FrameAwareDinoNetwork, AttentiveProbe
from sklearn.utils.class_weight import compute_class_weight
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../..")))
from lossFun import FocalLoss
from dataloader import  create_val_train_splits, get_dataset
...
if __name__ == "__main__":
    ...
    features,labels, fps_list=get_dataset(train_set_path, "dinov3_features",frame_aware=False)
