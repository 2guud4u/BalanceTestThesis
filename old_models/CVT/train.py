...
import os 
import sys
from network import CVTNetwork
from sklearn.utils.class_weight import compute_class_weight
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../..")))

from dataloader import  get_cvt_dataset, create_val_train_splits, get_label_mapping
...
if __name__ == "__main__":
    ...
    features,labels, fps_list=get_cvt_dataset(train_set_path)
