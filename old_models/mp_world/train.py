...
from network import MP_World_Classifier
from dataloader import  get_world_pose_dataset, create_val_train_splits
...
if __name__ == "__main__":
    ...
    features,labels, fps_list=get_world_pose_dataset("/code/jjiang23/pathml/aim2_balance/processed_files/train_set.txt")
    ...
    model = MP_World_Classifier().to(device)
