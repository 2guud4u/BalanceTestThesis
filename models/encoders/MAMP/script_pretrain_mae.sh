...
# NTU120 xset with 256 frames
python -m torch.distributed.launch --nproc_per_node=4 --master_port 11234 main_pretrain.py \
--config /code/jjiang23/pathml/aim2_balanceV2/models/encoders/MAMP/config/ntu256_xset/pretrain_mae_t256_layer8+5_mask90.yaml \
--output_dir ./output_dir/ntu256_xset_joint/pretrain_mae_t256_layer8+5_mask90_ep400_noamp \
--log_dir ./output_dir/ntu256_xset_joint/pretrain_mae_t256_layer8+5_mask90_ep400_noamp